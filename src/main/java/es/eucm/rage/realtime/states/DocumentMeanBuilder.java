 ...
 */
public class DocumentMeanBuilder implements Function {

	private static final Logger LOG = Logger.getLogger(DocumentMeanBuilder.class
			.getName());
	 ...
	 */
	public DocumentMeanBuilder(String sessionId, String defaultTraceKey) {
	...
	public void execute(TridentTuple tuple, TridentCollector collector) {
		...
		Map results = (Map) tuple.getValueByField(defaultTraceKey);


		Document<Map> doc = new Document(tracesIndex,
				ESGameplayState.RAGE_TRACES_DOCUMENT_TYPE, results, null);
